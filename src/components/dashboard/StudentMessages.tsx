...
import { mockConversations, mockMessages, Conversation, Message } from '@/data/mockData';
        ...
        <CardHeader className="pb-3 border-b flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <h3 className="font-semibold text-sm">{selectedConversation.participantName}</h3>
            ...
            {conversationMessages.map((message) => (
              ...
              >
                ...
                >
                  ...
                  <p className={cn(
                    "text-[10px] mt-1",
                    message.senderRole === 'student' ? "text-primary-foreground/70" : "text-muted-foreground"
                  )}>
